...
class test_register_artist(TestCase):
    ...
    def test_positive1(self):
        form1 = ArtistForm(data={'email': "artist_test1@test.com", 'password': "password_test1",
    ...
    def test_positive2(self):
        form2 = ArtistForm(data={'email': "artist_test2@test.com", 'password': "password_test2",
    ...
    def test_positive3(self):
        form3 = ArtistForm(data={'email': "artist_test3@test.com", 'password': "password_test3",
    ...
    def test_negative1(self):
        form4 = ArtistForm(data={'email': "", 'password': "password_test1",
                                     'name': "name_test1", 'username': "username_test1",
                                     'logo': "https://www.logotest1.com", 'description': "description_test1",
                                     'artistNumber': 10})
    ...
    def test_negative2(self):
        form5 = ArtistForm(data={'email': "artist_test2@test.com", 'password': "",
                                     'name': "name_test2", 'username': "username_test2",
                                     'logo': "https://www.logotest2.com", 'description': "description_test2",
                                     'artistNumber': 3})
    ...
    def test_negative3(self):
        form6 = ArtistForm(data={'email': "artist_test3@test.com", 'password': "password_test3",
    ...
    def test_negative4(self):
        form7 = ArtistForm(data={'email': "artist_test4@test.com", 'password': "password_test4",
